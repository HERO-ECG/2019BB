...
extern double accgyo[7];								//用于存储各个从MPU中读到的原始值
...
#define A 0.000598144531
#define B 0.0609756098
#define T 0.00294117647





extern IIC_STRUCT MPU_I2C;//MPU所用的IIC结构体
