...
void CustomShapeTransmit(void)
{
	...
	{
		custom_shape.operate_tpye = 3;
		beat=0;
	}
	if(Chassis.follow.mode.now==BACK_FOLLOW)
		custom_shape.graphic_tpye = 2;
	else if(Chassis.follow.mode.now==SPIN)
		custom_shape.graphic_tpye = 3;
	else
		custom_shape.graphic_tpye = 0;
	...
	if(Chassis.speed.spin_fast==0&&Chassis.follow.mode.now==SPIN)
		custom_shape.color = 3;
	else
		custom_shape.color = 1;
	custom_shape.width = 3;
	if(custom_shape.graphic_tpye == 3)
	{
		custom_shape.start_x = 960;
...
//	CustomShapeMessage[13]= 1;//custom_shape.operate_tpye;   
//	CustomShapeMessage[14]= 3;//custom_shape.graphic_tpye;
//	CustomShapeMessage[15]= 0;//custom_shape.graphic_name[0];
//	CustomShapeMessage[16]= 0;//custom_shape.graphic_name[1];
//	CustomShapeMessage[17]= 0;//custom_shape.graphic_name[2];
//	CustomShapeMessage[18]= 0;//custom_shape.graphic_name[3];
//	CustomShapeMessage[19]= 0;//custom_shape.graphic_name[4];
//	CustomShapeMessage[20]= 9;//custom_shape.layer;
//	CustomShapeMessage[21]= 1;//custom_shape.color;
//	CustomShapeMessage[22]= 0x0A;//custom_shape.width;
//	CustomShapeMessage[23]= (uint8_t)(0X021C);//custom_shape.start_x;
//	CustomShapeMessage[24]= 0X021C>>8;//custom_shape.start_x>>8;
//	CustomShapeMessage[25]= (uint8_t)0X021C;//custom_shape.start_y;
//	CustomShapeMessage[26]= 0X021C>>8;//custom_shape.start_y>>8;
//	CustomShapeMessage[27]= 0X0064;//custom_shape.radius;
//	CustomShapeMessage[28]= 0X0064>>8;//custom_shape.radius>>8;
//	CustomShapeMessage[29]= (uint8_t)(960);//custom_shape.end_x;
//	CustomShapeMessage[30]= 0>>8;//custom_shape.end_x>>8;
//	CustomShapeMessage[31]= 0;//custom_shape.end_y;
//	CustomShapeMessage[32]= 0>>8;//custom_shape.end_y>>8;
//	CustomShapeMessage[33]= (int8_t)0;//custom_shape.start_angle;
//	CustomShapeMessage[34]= 0>>8;//custom_shape.start_angle>>8;
//	CustomShapeMessage[35]= 0;//custom_shape.end_angle;
//	CustomShapeMessage[36]= 0;//custom_shape.end_angle>>8;
//	CustomShapeMessage[37]= 0;//custom_shape.text_lengh;
	for(i=0;i<30;i++)
	{
